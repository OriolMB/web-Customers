...
<?php
        ...
        echo "It doesn't customers";
    }
    tancarConnexioBD();
?>
<a type="button" href="form_customers.php?operacio=new" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> New Costumer</a>
